...
//static const char encodingTable[] = "0123456789abcdef";
...
{
    NSMutableArray *jobList = [NSMutableArray arrayWithArray:[LPUtility unarchiveDataFromCache:@"JobRecordList"]];
    BOOL exist = NO;
    ...
    [LPUtility archiveData:jobList IntoCache:@"JobRecordList"];
}
                           ...
                           size:(CGSize)size
{
    ...
    CGFloat height = [LPUtility heightStringWithEmojis:text fontType:font ForWidth:size.width];
...
+ (void)showLaunchImageNameInView:(UIView *)view{
    UIImageView *launchView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[LPUtility LaunchImageName]]];
